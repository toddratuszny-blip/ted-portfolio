          ...
          <div className="flex flex-col gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center gap-6 md:flex-row">
              ...
              <p className="max-w-2xl text-center font-sora text-base leading-relaxed text-gray-800 md:text-left md:text-xl">
                I help organizations build stronger brands through thoughtful
                strategy, creative leadership, and practical execution. If my
                experience aligns with your team&apos;s needs, I&apos;d welcome
